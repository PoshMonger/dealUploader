...
import { TextField, Button, text, Card, Divider, Grid, } from '@material-ui/core';
...
const Form = ({ currentId, setCurrentId, }) => {
  ...
  const [postData, setPostData] = useState({
    expireDate: '', city: '', state: '', zipcode: '', message: '', address: '', email: '', arv: '', squareFoot: '', listPrice: '',
    bedBath: '', acreage: '', tags: [], costofrepairs: '', parcelnum: '', enviroprobs: '', comparableurl: '', virtualtoururl: '',
    zoning: '', selectedFilerentroll: '', selectedFileproforma: '', selectedFile1: '', selectedFile2: '',
    selectedFile3: '', selectedFile4: '', selectedFile0: '', selectedFile6: '', selectedFile7: '', type: 'flip'
  });
  ...
  const clear = () => {
    setCurrentId(0);
    setPostData({
      expireDate: '', city: '', state: '', zipcode: '', type: 'flip', message: '', tags: [], address: '', email: '', arv: '', squareFoot: '', listPrice: '',
      bedBath: '', acreage: '', costofrepairs: '', parcelnum: '', enviroprobs: '', comparableurl: '', virtualtoururl: '', zoning: '',
      selectedFilerentroll: '', selectedFileproforma: '', selectedFile2: '', selectedFile1: '', selectedFile3: '', selectedFile4: '',
      selectedFile5: '', selectedFile6: '', selectedFile7: ''
    });
  };
  ...
  const validate = () => {
    ...
    if (!postData.listPrice) {
      listPriceError = "Please Enter List Price";
    }

    if (postData.listPrice.length > 25) {
      listPriceError = "List Price Cannot Exceed 25 Characters";
    }



    if (!postData.arv) {
      arvError = "Please Enter ARV";
    }

    if (postData.arv.length > 15) {
      arvError = "ARV Cannot Exceed 8 Characters";
    }
        ...
        <form autoComplete="off" noValidate className={`${classes.root} ${classes.form}`} onSubmit={handleSubmit}>
          ...
          <Grid item  xs={12} md={12} lg={12} sm={12}>
            <Card className={classes.card}>
              <text variant="h6">{currentId ? `Editing "${post?.address}"` : <text className={classes.heading} variant='h4' align='center'> Post a Flip</text>}</text>
          ...
          <Grid item  xs={12} md={12} lg={12} sm={12}>
            <Card className={classes.card}>
              ...
              <TextField name="costofrepairs" variant="outlined" label=" Estimated Cost Of Repairs" fullWidth value={postData.costofrepairs} onChange={(e) => setPostData({ ...postData, costofrepairs: e.target.value })} />
              <TextField name="arv" variant="outlined" label=" Estimated ARV" fullWidth value={postData.arv} onChange={(e) => setPostData({ ...postData, arv: e.target.value })} />
              <TextField name="bedBath" variant="outlined" label="Estimated bedBath" fullWidth value={postData.bedBath} onChange={(e) => setPostData({ ...postData, bedBath: e.target.value })} />
          ...
          <Grid item  xs={12} md={12} lg={12} sm={12}>
            <Card className={classes.card}>
              ...
              <TextField name="comparableurl" variant="outlined" label="Comparables Url" fullWidth value={postData.comparableurl} onChange={(e) => setPostData({ ...postData, comparableurl: e.target.value })} />
              ...
              <text>Deal Expiration Date</text>
          ...
          <Grid item  xs={12} md={12} lg={12} sm={12}>
            <Card className={classes.card}>
              ...
              <Divider style={{ margin: '20px 0' }} />
              <Grid item>
                <text className={classes.tagsdesc} variant="body1">Press "Enter" to create Tag</text>
        ...
        <form autoComplete="off" noValidate className={ classes.form} onSubmit={handleSubmit}>
          ...
          <Grid item xs={12} md={12} lg={12} sm={12}>
            <Card className={classes.card}>
              ...
              <TextField className={classes.textfield} name="address" variant="outlined" label="Street Address / Title" fullWidth value={postData.address} onChange={(e) => setPostData({ ...postData, address: e.target.value })} />
              <TextField className={classes.textfield} name="city" variant="outlined" label="City" fullWidth value={postData.city} onChange={(e) => setPostData({ ...postData, city: e.target.value })} />
              <TextField className={classes.textfield} name="state" variant="outlined" label="State" fullWidth value={postData.state} onChange={(e) => setPostData({ ...postData, state: e.target.value })} />
              <TextField className={classes.textfield} name="zipcode" variant="outlined" label="Zip Code" fullWidth value={postData.zipcode} onChange={(e) => setPostData({ ...postData, zipcode: e.target.value })} />
          ...
          <Grid itemxs={12} md={12} lg={12} sm={12}>
            <Card className={classes.card}>
