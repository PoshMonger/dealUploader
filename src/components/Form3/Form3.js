...
import { TextField, Button, text, Paper,Card , Divider,Grid} from '@material-ui/core';
...
const Form = ({ currentId, setCurrentId }) => {
  ...
  const [postData, setPostData] = useState({expireDate:'', acreage:'', mediansaleprice:'', city:'',state:'',zipcode:'', message: '',permitstage:'', address:'',email:'',listPrice: '',
   tags: [], costofrepairs:'', parcelnum:'',enviroprobs:'', comparableurl:'',virtualtoururl:'', zoning:'',NOI:'',selectedFilerentroll:'',
   selectedFileproforma:''   , selectedFile1: '' ,selectedFile2:'' , selectedFile3: '' ,selectedFile4:'' , selectedFile5: '' ,
   selectedFile6:'' , selectedFile7: '' ,type:'build'});
  ...
  const clear = () => {
    setCurrentId(0);
    setPostData({expireDate:'', acreage:'', mediansaleprice:'',city:'',state:'',zipcode:'',type:'build', message: '',permitstage:'', tags: [], address:'',email:'',listPrice:'',
   costofrepairs:'', parcelnum:'',enviroprobs:'', comparableurl:'',virtualtoururl:'', zoning:'',NOI:'', selectedFilerentroll:'',
   selectedFileproforma:''   , selectedFile2: '' ,selectedFile1:'',  selectedFile3: '' ,selectedFile4:'' , selectedFile5: '' 
   ,selectedFile6:'' , selectedFile7: '' , });
  };
  ...
  const validate = () => {
    ...
    if (mediansalepriceError){
      alert(mediansalepriceError)
      return false
    }
 ...
 >
     <Grid item  xs={12} md={12} lg={12} sm={12}>
      ...
      <Grid item  xs={12} md={12} lg={12} sm={12}>
        ...
        <text className={classes.heading}   variant="h6">{currentId ? `Editing "${post?.address}"` :  <text className={classes.heading}  variant='h4'align='center'> Post a Build</text>}</text>
  ...
  <Grid item  xs={12} md={12} lg={12} sm={12}>
        ...
        *Please Do Not Use Commas*
        ...
        <TextField name="permitstage" variant="outlined" label="Permitting Stage" fullWidth value={postData.permitstage} onChange={(e) => setPostData({ ...postData, permitstage: e.target.value })} />

        <TextField name="mediansaleprice" variant="outlined" label="Median New Sale Price" fullWidth value={postData.mediansaleprice} onChange={(e) => setPostData({ ...postData, mediansaleprice: e.target.value })} />
